  ...
  for (let i = 0; i < boxCount; i++) {
    ...
    div.onclick = () => {
      ...
      if (c == i + 1) {
        ...
        r.querySelector("h1").innerHTML = 'Congrats! You <span style="color: #ff2b2b;">failed</span>!';
        r.querySelector("h3").innerHTML = "Now, you have to subscribe (and add me on Discord if your Anthony, username: axorax)";
      }
    };
